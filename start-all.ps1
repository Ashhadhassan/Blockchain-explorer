...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'C:\Users\Ashhad Hassan\Videos\DB_PROJECT\DB'; Write-Host '🎨 Frontend Server Starting...' -ForegroundColor Green; Write-Host 'Port: 3000' -ForegroundColor Cyan; Write-Host 'URL: http://localhost:3000' -ForegroundColor Cyan; Write-Host ''; npm run dev"
